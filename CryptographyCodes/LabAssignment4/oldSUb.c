...
printf("\n\n");
        ...
        printf("Enter 256-bit  KA which you got in hexadecimal format (32 bytes): ");
        for (int i = 0; i < 32; i++) {
            scanf("%2hhx", &input[i]);
        }
        input[31]= input[31] ^1;
        ...
        for(int i=32;i<96;i++)
        {
            hashinput[i] = concat[i-32];
        }
        //print hash input
        printf("\n\n");
        printf("Hash input is : ");
        for(int i = 0 ; i<96 ; i++)
        {
            printf("%02x ",hashinput[i]);
        }
        sha256(hashinput);
...
void sha256(int plaintext[] ){
    ...
    for(int i = 0 ; i<8;i++){
        ...
        for(int i = 0 ; i<2;i++){
        int *p = internal(h0,h1,h2,h3,h4,h5,h6,h7,paddedMessage2);
        for(int i = 0 ; i<8;i++){
        printf("%x",*(p + i));
        }
        printf("\n")   ;
...
int padding(int length,int plaintext[]){
    ...
    void DecryptAES(unsigned char iv1[16]){
        // printf("Input to  decryption from AES is :");
        // for(int i = 0 ;i<4;i++)
        // {
        //     for(int j = 0 ;j<4;j++)
        //     {
        ...
        xorWithKey(0);
        // printf("Output of decryption from AES is :");
        // for(int i = 0 ;i<4;i++)
        // {
        //     for(int j = 0 ;j<4;j++)
        //     {
    ...
    void Decryption(){
        ...
        // printf(" \n ciphertext 2 before 1st decrypt call is :  \n ");
        // for (int i = 0; i < 4; i++)
        // {
        //     for (int j = 0; j < 4; j++)
        //     {
        ...
        // }
        DecryptAES(iv);
        // printf(" \n  ciphertext 1 after 1st decrypt call is :  \n ");
        // for (int i = 0; i < 4; i++)
        // {
        //     for (int j = 0; j < 4; j++)
        //     {
        ...
        // printf(" \n  IV is : Before second decrypt call \n ");
        // for(int i = 0 ; i<16;i++)
        // {
        //     printf("%02x ",iv[i]);
        // }
    ...
    void Encryption()
    {
        printf("Enter the 256 bit key KA which is shown on your screen: ");
        for (int i = 0; i < 32; i++)
        {
            scanf("%2hhx", &key[i]);
        }
        ...
        copyIV(iv);
        printf(" \n before going to second block IV is : \n ");
        for(int i = 0 ; i<16;i++)
        {
            printf("%02x ",iv[i]);
        }
